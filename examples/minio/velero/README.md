...
This helm chart installs Velero version v1.4.0 https://github.com/velann21/velero/tree/v1.4.0. See the [#Upgrading](#upgrading) section for information on how to upgrade from other versions.
