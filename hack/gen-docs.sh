...
if [[ $(uname) == "Darwin" ]]; then
    ...
    find site/docs/${NEW_DOCS_VERSION} -type f -name "*.md" | xargs sed -i '' "s|https://github.com/velann21/velero/blob/master|https://github.com/velann21/velero/blob/$VELERO_VERSION|g"
