...
Velero follows the [Semantic Versioning](http://semver.org/) standard for releases. Each tag in the `github.com/velann21/velero` repository has a matching image, e.g. `velero/velero:v1.0.0`.
