...
This section documents some of the choices made during implementation of the Velero [CSI plugin](https://github.com/velann21/velero-plugin-for-csi/):
...
1. The Velero [CSI plugin](https://github.com/velann21/velero-plugin-for-csi/), to backup CSI backed PVCs, will choose the first VolumeSnapshotClass in the cluster that has the same driver name. _[Issue #17](https://github.com/velann21/velero-plugin-for-csi/issues/17)_
